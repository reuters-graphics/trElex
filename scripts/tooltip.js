...
class setTooltip {
    ...
    update() {
        this.tt = d3.select(this.element).append("div").classed("custom-tooltip", true);
    ...
    updateFields(d) {
        ...
        let percentReporting = d3.format(".1%")(d.data.precincts.pRep / d.data.precincts.pTot)
    ...
    position(coords, settings, quad) {
        ...
        this.tt.classed('tooltip-active', true)
